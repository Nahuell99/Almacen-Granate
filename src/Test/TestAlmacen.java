...
public class TestAlmacen {
	...
	public static void main(String[] args) {
		...
		Cliente cliente2 = new Cliente(3,
				...
				42231767L, 'f');
		Cliente cliente3 = new Cliente(4, new Contacto("maurirossi@gmail.com", "1532326323", new Ubicacion(315L, 25L)),
				"Mauricio", "Rossi", 63987541L, 'f');
		Cliente cliente4 = new Cliente(5, new Contacto("fedeprocs@gmail.com", "15151611", new Ubicacion(123L, 823L)),
				"Federic", "Procs", 35426987L, 'm');
